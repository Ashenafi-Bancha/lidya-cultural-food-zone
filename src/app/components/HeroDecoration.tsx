...
const EL = [
  ...
  // tej teardrops
  { t:"tej",    top:"32%", left:"18%",  s:15, dur:5.5, delay:1.0, type:"bob"     },
  { t:"tej",    top:"58%", left:"72%",  s:14, dur:6.5, delay:2.5, type:"drift"   },
  { t:"tej",    top:"14%", left:"66%",  s:16, dur:5.0, delay:0.3, type:"bob"     },
  { t:"tej",    top:"88%", left:"45%",  s:14, dur:6.0, delay:1.7, type:"drift"   },
  // diamonds
