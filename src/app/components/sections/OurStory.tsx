...
export function OurStory() {
  return (
    <section id="our-story" className="bg-[#f5efe6] py-16 md:py-24 lg:py-32 overflow-hidden">
          ...
          <Reveal delay={0.18}>
            <div className="flex flex-col gap-5">
              ...
              <p className="text-[#1e1008]/65 leading-relaxed" style={{ fontFamily: "var(--font-lidya-body)" }}>
                What began as a family dream has grown into a cultural institution. Every dish we serve carries memory — in every bowl of kitfo, every pour of tej, every smoke rising from the coffee ceremony. We do not just cook; we preserve.
              </p>
              <p className="text-[#1e1008]/65 leading-relaxed" style={{ fontFamily: "var(--font-lidya-body)" }}>
