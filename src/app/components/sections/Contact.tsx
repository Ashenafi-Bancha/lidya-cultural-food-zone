          ...
          <Reveal delay={0.1} className="lg:col-span-3">
            <AnimatePresence mode="wait">
              {sent ? (
                ...
                <motion.form
                  key="form"
                  onSubmit={e => { e.preventDefault(); setSent(true); setTimeout(() => setSent(false), 4000); setForm({ name: "", email: "", subject: "", message: "" }); }}
                ...
                >
                  ...
                  <motion.button
                    type="submit"
                    className="mt-1 flex items-center justify-center gap-2 py-4 text-[11px] tracking-[0.2em] uppercase"
                    style={{ fontFamily: "var(--font-lidya-sans)", background: "#c25e2a", color: "#faf5ee" }}
                    whileHover={{ backgroundColor: "#1e1008", color: "#faf5ee" }}
                    whileTap={{ scale: 0.98 }}
