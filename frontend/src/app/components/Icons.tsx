...
export const Icon = {
  ...
  Star: ({ filled }: { filled?: boolean }) => (
    <svg viewBox="0 0 24 24" width="1em" height="1em" fill={filled ? "#d4a843" : "none"} stroke={filled ? "none" : "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
