...
export function Branches() {
  ...
  // API is the source of truth — no fabricated fallback content. The imported
  // photos are only used as a placeholder image when a branch has no imageUrl.
                  ...
                  <div className="p-5 sm:p-8 flex-1 flex flex-col">
                    ...
                    <div className="space-y-3 mt-auto">
                      {[
                        ...
                        { I: Icon.Clock,  v: tf(b, "workingHours"), href: null },
                    ...
                    >
                      <Icon.ExternalLink /> {t("branches.getDirections")}
                    </motion.a>
                  </div>
                </motion.div>
              </Reveal>
