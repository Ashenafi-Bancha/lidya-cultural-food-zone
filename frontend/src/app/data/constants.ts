...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 5, name: "Jebena Buna",     cat: "Coffee Ceremony",      desc: "Three rounds of freshly roasted Wolaita highland coffee with popcorn and incense.",                   price: "520 ETB", img: menuPhoto("jebena-buna.jpg"),     fallbackImg: "https://images.unsplash.com/photo-1631166092772-d07aed54b9a0?w=600&h=400&fit=crop&auto=format", tag: "Ceremony" },
  ...
  { id: 8, name: "Awaze Tibs",      cat: "Traditional Mains",    desc: "Prime beef sautéed with awaze paste, tomatoes, and jalapeño — fiery and unapologetically Wolaita.",   price: "560 ETB", img: menuPhoto("awaze-tibs.jpg"),     fallbackImg: "https://images.unsplash.com/photo-1541518763669-27fef04b14ea?w=600&h=400&fit=crop&auto=format", tag: "Spicy" },
  ...
  { id: 12, name: "Lidya Special Plate 4", cat: "Traditional Mains", desc: "An authentic culinary experience bringing you the best of Wolaita.",                              price: "650 ETB", img: menu4,                            fallbackImg: menu4, tag: "New" },
];
